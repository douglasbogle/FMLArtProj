...
if __name__ == '__main__':
    ...
    #all_visual_features = torch.zeros_like(all_visual_features) uncomment to test w/o images
    ...
    MODEL_PATH = 'best_slim_artnet_test.pt'
    train_history, val_history = [], []

    # Check for existing weights, else train
    ...
    # Find a lot where we beat expert to display later if necessary
